...
<div class="col-sm-3">
						...
						<form action="" method="post">
							...
							<div class="form-group" id="teacher-phone-group">
								<div class="input-group">
									<input type="contact number" name="fon" class="form-control" id="teacher-input-phone" placeholder="contact number">
...
<?php
 include'config.php';
	...
	$insert = "insert into teacher values(' ','$name',' ',' ',' ','$email','$fon')";	
...
?>
					...
					<div class="col-sm-3">
						...
						<p>Phone: <a href="tel:1800123456">6283344768</a><br>
						Landline: <a href="tel:1800123456">2792576</a><br>
						Email: <a href="mailto:abc123@gmail.com">rs53189@gmail.com</a></p>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-4 text-right">
						<a href="https://www.facebook.com/xyyz"><i class="fa fa-facebook fa-lg"></i></a>
						<a href="http://www.twitter.com/xyyz"><i class="fa fa-twitter fa-lg"></i></a>
						<a href="http://www.linkedin.com/xyyz"><i class="fa fa-linkedin fa-lg"></i></a>
						<a href="http://www.youtube.com/xyyz"><i class="fa fa-youtube fa-lg"></i></a>
					</div>
					<!-- ==== SOCIAL ICONS END == -->
